...
Example1 = {
    ...
    'Equipment1': {
        ...
        'Model_Parameters': {
            ...
            # "s_flow": 0,
            "comp_f": np.array([0.1, 0.9, 0]),
            # "comp_s": np.array([0.0, 0.0, 1.0]),
            'V_Sweep_Target': 0*np.array([0.0, 0.0, 1.0]),
            "Q": np.array([3.207e-9, 1.33e-10, 3.968e-10]), # Permeance [mol/(m2 Pa s)]
            "S": np.array([3.207e-9, 1.33e-10, 3.968e-10])*25e-6, # Permeability [mol/(m Pa s)]
