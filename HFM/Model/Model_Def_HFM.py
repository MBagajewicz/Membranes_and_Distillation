...
Model_HFM = {
    ...
    'Model_Info': {
        ...
        'Standard_Variables_Values': {
            ...
            'Void_Frac': list(np.round(np.linspace(0.2,0.5,31),2)) # 0.30,0.31,0.32...
        }
    ...
    'Set_Trimming_Info': {
        ...
        # 'Primordial_Set_Trimming_Constraints_List': ['LD_lb', 'LD_ub', 'esp_LB', 'esp_UB', 'Min_Area_Specification'],
        'Primordial_Set_Trimming_Constraints_List': ['LD_LB_UB','esp_LB_UB', 'Re_Shell_Feed','Re_Bore_Out',
                                                     'Max_Mach_Bore', 'Max_Mach_Shell'],
        ...
        'Set_Trimming_Constraints_List': ['Max_Area_Loss','Min_Area_Specification'],   # 'Dpr_max','Dpp_max'  these are proxy constraints
    ...
    'Enumeration_Info': {
        ...
        'Enumeration_Constraint_List': ['Max_comp_ret_AND_Max_loss_perm_AND_Tdew_AND_dP'],
