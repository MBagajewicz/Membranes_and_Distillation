...
#######################################################################
    ...
    'Global_Optimizer': {
        ...
        'Selected_Optimizer': 'Parameter Enumeration',
        # Bounds must be given in the same order as model optimization variables
        #  ['Separation','Limit_other_comp_Perm']
      
        'Lower_Bounds': [0.5,0.5],
   
        'Upper_Bounds': [0.98, 0.99]
    },
}
# endregion
